...
user-guide-description: '''通过将Adobe Commerce或Magento Open Source与您的集成，增加销售额并扩大客户群 [!DNL Walmart Marketplace] 卖方中心账户。'
...
# 渠道管理员 —  [!DNL Channel Manager] 适用于Adobe Commerce的 {#channel-manager}
