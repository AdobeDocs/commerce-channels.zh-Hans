...
user-guide-description: 通过将Adobe Commerce或Magento Open Source与您的集成，通过Amazon生成销售额 [!DNL Amazon Seller Central] 帐户。
...
# Amazon sales channel - [!DNL channel manager] 适用于Adobe Commerce的 {#amazon}
